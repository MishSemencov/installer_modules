$(document).ready(function() {
  ...
  $('.custom-drag').on('mousedown', '.item', function(e) {
    ...
    if (window[$('.custom-drag').data('onstart')]) {
      window[$('.custom-drag').data('onstart')](event, null, serializeDraggable($('.custom-drag')));
    }
  ...
  $(document).on('mouseup', function(e) {
    ...
    if (window[$('.custom-drag').data('ondrop')]) {
      window[$('.custom-drag').data('ondrop')](event, null, serializeDraggable($('.custom-drag')));
    }
